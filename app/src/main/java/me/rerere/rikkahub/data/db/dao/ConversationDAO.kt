// [X-custom] RikkaHub-X 定制(merge 上游时保留): 会话级模型覆盖字段 model_id
...
interface ConversationDAO {
    ...
    @Query("UPDATE conversationentity SET model_id = :modelId WHERE id = :id")
    suspend fun updateModelId(id: String, modelId: String)
